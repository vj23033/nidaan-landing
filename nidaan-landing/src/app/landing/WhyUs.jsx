...
const WhyUs = () => {
  return (
   ...
   <div className='flex flex-col gap-[12px]'>
     <h1 className='text-center text-[length:var(--heading-h3)] leading-[52px] font-bold text-[#ffffff]'>
        Why Choose Us?
      </h1>
      <p className='text-center text-white sm:text-[18px] leading-[26px] font-normal sm:max-w-[60%] mx-auto' style={{ color: "rgba(255, 255, 255, 0.7)" }}>
