...
const SetupBanner = () => {
    return (
        ...
        <div className='max-w-[1440px] flex flex-col-reverse sm:flex-row  justify-center sm:gap-[80px] items-start sm:px-[120px] sm:py-[70px] px-[16px] py-[40px]  gap-[50px] text-white 3xl:mx-auto'>
