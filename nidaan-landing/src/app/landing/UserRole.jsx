    ...
    return (
        <div className='sm:py-[60px] sm:px-[120px] px-[16px] py-[42px] bg-[#E6F0FF] flex flex-col gap-[20px]'>
            ...
            <div className='py-[20px] gap-4'>
                <h1 className='text-center text-[32px] leading-[40px] font-bold text-[#172026] lg:text-[44px] lg:leading-[58px]'> 8+ Versatile User Roles </h1>
                <p className='text-center sm:text-[18px] sm:leading-[26px] text-[#71717A]'>Enhance hospital management efficiency with robust user role system,ensuring<br /> privacy, security, and tailored functionality for diverse healthcare professionals</p>
            </div>
