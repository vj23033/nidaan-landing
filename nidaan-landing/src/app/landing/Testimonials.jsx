    ...
    return (
        <>        <div className='flex flex-col py-[40px] items-center'>
            <div className='flex flex-col items-center gap-[20px] text-center px-[20px] sm:p-0'>
                <p className='bg-[#E1E8FE] sm:text-[18px] font-semibold text-[#201D49] px-[15px] py-[10px] max-w-fit rounded-[100px]'>Testimonials</p>
                <h3 className=' sm:text-[48px] leading-[58px] font-extrabold'>Why our customers loves us</h3>
                <p className='text-[length:var(--md-text)] leading-[28px] text-[color:var(--grey)] sm:max-w-[60%]'>We’re trusted by <span className='text-[color:var(--purple)] font-medium'>+1500</span> Hospitals in <span className='text-[color:var(--purple)] font-medium'>+6</span> States. Explain what results you’ve gained for your customers.</p>
                {/* <img src="/brands.png" alt="brands" className='my-[60px]' /> */}
                <div className='my-[60px]'>
                    <Brands height={32} width={169} />

                </div>
            </div>

            <div className='flex flex-col flex-wrap gap-[20px] sm:max-h-[900px] testimonials_container px-[20px]'>
                {
