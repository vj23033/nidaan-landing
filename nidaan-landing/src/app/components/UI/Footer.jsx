  ...
  return (
    <footer className=''>
     ...
     <div className='flex sm:flex-row flex-col gap-[10px]  justify-between sm:px-[120px] px-[20px] border border-b py-[40px]'>
            ...
            <img className="" src='./logo.jpeg' alt="Logo" width={40} height={40} />
      ...
      <div className='sm:px-[120px] px-[20px]'>
        <ItemsContainer />

      </div>

      <div className="flex flex-col-reverse gap-[10px] sm:flex-row sm:px-[120px] sm:py-[20px] px-[20px] justify-between text-center pt-2 text-gray-400 text-[18px] pb-8 border-t border-solid border-[#E4E4E7]">
